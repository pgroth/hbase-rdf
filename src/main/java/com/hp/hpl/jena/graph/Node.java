...
/**
    ...
    REVISION: add a new subtype NodeId
*/
...
public abstract class Node {
    ...
    */
    ...
    public static Node createId( Object id){
    	return create(makeNodeId, id);
    }
    ...
    */                     
    ...
    /** 
         Answer true if this node is a literal node [subclasses override]
    */
    public boolean isLiteral() 
        { return false; }
    
    /** 
        Answer true if this node is a blank node [subclasses override]
    */
    public boolean isBlank()
        { return false; }
    
    /** 
         Answer true if this node is a URI node [subclasses override]
    */
    public boolean isURI()
        { return false; }
        
    /** 
        Answer true if this node is a variable node - subclasses override
    */
    public boolean isVariable()
        { return false; }
    
    /**
     * Answer true if this node is an Id node - subclasses override
     */
    public boolean isId()
    { return false; }
    ...
    */
    ...
    public Id getId()
    { throw new UnsupportedOperationException( "this (" + this.getClass() + ") is not an Id node" ); }
    ...
    static final NodeMaker makeNodeId = new NodeMaker()
    { @Override
    Node construct( Object x ) { return new NodeId( x ); } };
