...
public class StringIdAssoc {
	...
	public static class Id2StringMapper extends
		...
		@Override
		protected void map(ImmutableBytesWritable key, HBaseValue value, Context context) throws IOException,
	...
	public static class String2IdMapper extends
		...
		@Override
		protected void map(ImmutableBytesWritable inKey, HBaseValue inValue, Context context) throws IOException,
				InterruptedException {
